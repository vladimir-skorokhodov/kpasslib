...
void main() {
  group('Database merge unit tests', () {
    ...
    test('adds new remote group to root', () {
      ...
      final group =
          remote.createGroup(parentGroup: remote.root, name: 'newgrp');
    ...
    test('adds new remote group to deep group', () {
      ...
      final group = remote.createGroup(
          parentGroup: remote.root.groups[1].groups[0], name: 'newgrp');
    ...
    test('adds new local group to root', () {
      ...
      final group = db.createGroup(parentGroup: remote.root, name: 'newgrp');
    ...
    test('adds new local group to deep group', () {
      ...
      final group = db.createGroup(
          parentGroup: db.root.groups[1].groups[0], name: 'newgrp');
    ...
    test('moves group back', () {
      ...
      var group4 = db.createGroup(parentGroup: db.root, name: 'g4');
      group4.uuid = ID.g4;
      group4.times.modification = KdbxTime(DT.upd1);
      group4.times.locationChange = KdbxTime(DT.upd1);
      var group5 = db.createGroup(parentGroup: db.root, name: 'g5');
      group5.uuid = ID.g5;
      ...
      group5 = remote.createGroup(parentGroup: remote.root, name: 'g5');
      group5.uuid = ID.g5;
      group5.times.modification = KdbxTime(DT.upd1);
      group5.times.locationChange = KdbxTime(DT.upd1);
      group4 = remote.createGroup(parentGroup: remote.root, name: 'g4');
      group4.uuid = ID.g4;
    ...
    test('inserts group at start', () {
      ...
      final group4 = remote.createGroup(parentGroup: remote.root, name: 'g4');
      group4.uuid = ID.g4;
      group4.times.modification = KdbxTime(DT.upd2);
      group4.times.locationChange = KdbxTime(DT.upd2);
