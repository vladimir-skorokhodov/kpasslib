...
class KdbxDatabase {
  ...
  /// Creates a new group with [name] and [icon] to a [parentGroup].
  KdbxGroup createGroup({
    required KdbxGroup parentGroup,
    required String name,
    ...
    parentGroup.groups.add(subGroup);
    return subGroup;
  }
  ...
  KdbxEntry importEntry(KdbxEntry entry, KdbxGroup target, KdbxDatabase other) {
